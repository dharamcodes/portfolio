...
export function Hero({ personal }: HeroProps) {
  return (
    <div
      className={`container ${styles["hero-content"]} slide-inner`}
    ...
    >
      <div className={styles["hero-text"]}>
        ...
        <div className={styles["hero-cta-row"]} suppressHydrationWarning>
          ...
          <a
            href="/Resume_Dharmendra.pdf"
            download="Resume_Dharmendra.pdf"
      ...
      <div className={styles["hero-image-wrapper"]}>
        ...
        <Image
          ...
          width={400}
          height={400}
          className={`${styles["hero-image"]} glass show-light`}
          priority
        />
        <Image
          ...
          width={400}
          height={400}
          className={`${styles["hero-image"]} glass show-dark`}
          priority
        />
      </div>
    </div>
